...
<head>
    <meta charset="UTF-8">
    <title>Struk Parkir — {{ $ticket->ticket_code }}</title>
    ...
    <div>
        <div class="receipt">
            <div class="receipt-header">
                ...
                <div class="receipt-sub">Struk Pembayaran Parkir</div>
            </div>
            ...
            <div class="receipt-status-wrap">
                <span class="receipt-status">✓ LUNAS</span>
            </div>
            ...
            <div class="receipt-body">
                ...
                <div class="receipt-row">
                    ...
                    <span>{{ $ticket->paid_time->format('d/m/Y H:i') }}</span>
                </div>
                ...
                @if($payment)
                    ...
                    <div class="receipt-row">
                        ...
                        <span>Rp {{ number_format($payment->base_amount, 0, ',', '.') }}</span>
                    </div>
            ...
            <div class="receipt-footer">
                <p>Keluar sebelum {{ $ticket->paid_time->addMinutes(\App\Models\ParkingSetting::getExpireMinutes())->format('H:i') }}</p>
                <p style="margin-top: 0.25rem;">Terima kasih atas kunjungan Anda</p>
                <p style="margin-top: 0.25rem;">{{ now()->format('d/m/Y H:i:s') }}</p>
            </div>
        </div>
        ...
        <div class="btn-group">
            ...
            <a href="{{ route('payment.index') }}" class="btn btn-back">← Kembali</a>
        </div>
    </div>
